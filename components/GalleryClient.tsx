...
const shots: GalleryItem[] = [
  ...
  ["album-04.jpg", "bath", "Баня", "Купель у тёплой террасы", "Купель Фурако рядом с крытой террасой", "portrait"],
  ...
  ["album-24.jpg", "bath", "Баня", "Горячая вода под открытым небом", "Уличная купель Фурако", "standard"],
  ...
  ["album-06.jpg", "bath", "Баня", "Летнее настроение", "Купель с надувным фламинго", "standard"],
  ...
  ["album-13.jpg", "bath", "Баня", "Купель в вечернем свете", "Купель Фурако с фиолетовой подсветкой", "landscape"],
  ["album-14.jpg", "bath", "Баня", "Вода, свет и тепло", "Вода в купели с вечерней подсветкой", "portrait"],
  ["album-15.jpg", "bath", "Баня", "Вечер у купели", "Накрытый стол рядом с купелью", "standard"],
  ["album-16.jpg", "bath", "Баня", "Мягкий гидромассаж", "Работающая купель Фурако с подсветкой", "landscape"],
  ...
  ["album-25.jpg", "bath", "Баня", "Напитки всегда рядом", "Подставка для напитков в купели", "portrait"],
  ["album-26.jpg", "relaxation", "Зона отдыха", "Бокал в тёплой воде", "Шампанское в зоне купели Фурако", "landscape"],
  ["album-27.jpg", "bath", "Баня", "Всё подготовлено к отдыху", "Купель Фурако и банные халаты", "portrait"],
  ["album-28.jpg", "bath", "Баня", "Купель для небольшой компании", "Просторная купель рядом с лавками", "standard"],
